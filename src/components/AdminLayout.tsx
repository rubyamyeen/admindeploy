...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-[#0d1526]">
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-56 bg-[#111827] border-r border-slate-800 transform transition-transform duration-200 lg:translate-x-0 ${
        ...
        <div className="flex flex-col h-full">
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between mx-2 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                        isActive
          ...
          <div className="p-4 border-t border-slate-800">
            <button
              ...
              className="w-full text-left px-3 py-2 text-sm text-slate-400 hover:text-white transition-colors"
            >
              Sign out
            </button>
          </div>
      ...
      {/* Mobile header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-[#111827] border-b border-slate-800">
